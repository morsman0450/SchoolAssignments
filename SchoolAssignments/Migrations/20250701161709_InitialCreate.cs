    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutomationStatuses", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                table: "AutomationStatuses",
                columns: new[] { "Id", "IsRunning", "LastCheck", "LastError", "ServiceName" },
                values: new object[] { 1, true, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "AutoGrading" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "FirstName", "IsActive", "LastName", "PasswordHash", "Role", "Username" },
                values: new object[] { 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@school.cz", "System", true, "Administrator", "$2a$11$heJOy7PjCswWolczamTSPuqjj./ZYYLrb3PsUhFO.FwO7rgTgTvti", 3, "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutomationStatuses_ServiceName",
                table: "AutomationStatuses",
                column: "ServiceName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Submissions_ActivityId_StudentId",
                table: "Submissions",
